...
*/
inline void lp_lines_intersection_point(vec2_t  a1,
                                        vec2_t  a2,
                                        vec2_t  b1,
                                        vec2_t  b2,
                                        vec2_t* p,
...
*/
inline bool
lp_lines_has_intersection(vec2_t a1, vec2_t a2, vec2_t b1, vec2_t b2);
...
#define VEC3_TO_ARR(vec) {vec.x, vec.y, vec.z}

#define VEC2_TO_ARR(vec) {vec.x, vec.y}
...
bool lp_lines_has_intersection(vec2_t a1, vec2_t a2, vec2_t b1, vec2_t b2)
{
...
void lp_lines_intersection_point(vec2_t  a1,
                                 vec2_t  a2,
                                 vec2_t  b1,
                                 vec2_t  b2,
                                 vec2_t* p,
